...
ALGORITHMS = [
    ...
    "cut_limited_loop_repair",
    "cut_limited_multi_body_loop",
    "cut_limited_length_bounded_loop",
    "cut_limited_body_support_guard",
    ...
    "prefix_block_support_only",
    "prefix_block_prefix_merge_only",
    "prefix_block_dominant_only",
    "prefix_block_support_guard",
    "prefix_block_grammar_only",
    "prefix_block_conservative_merge",
    "prefix_block_ambiguity_aware",
